...
- Codex (skills, hooks, subagents, configs)
...
|---------|---------|---------|
| [`hooks/`](hooks/README.md) | Scripts shell exécutés par Codex | Événements PreToolUse, PostToolUse, etc. |
| [`skills/`](skills/README.md) | Skills Codex réutilisables | Slash commands, agents spécialisés |
